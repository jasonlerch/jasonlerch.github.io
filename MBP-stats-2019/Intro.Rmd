...
ht[2,2] <- "Introduction. Data organization, descriptive statistics, plotting, basic linear models. "
ht[3,2] <- "Group assignment #1"
#rowspan(ht)[2, 2] <- 2

ht[2,3] <- "Probability in all its glory. Multiple linear models, interactions, p values, multiple comparisons. "
ht[3,3] <- "Group assignment #2"
#rowspan(ht)[2,3] <- 2

ht[2,4] <- "Hypothesis testing, searching for truth, and the crisis of replicability"
#rowspan(ht)[4,4] <- 2
